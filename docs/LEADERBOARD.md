...
- First-run welcome does not request or show the Hall. After the player's first finished game, the browser profile reveals it on the centered main menu. Profile editing and level selection keep it out of the active decision surface.
