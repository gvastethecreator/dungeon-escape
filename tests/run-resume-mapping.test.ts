  ...
  test("captures every live resume field without retaining aliases", () => {
    ...
    const captured = captureRunResume({
      ...
      world: {
        ...
        cullBrandRemaining: 0,
        shotgunShells: 4,
        shotgunPumpRemaining: 0.2,
    ...
    expect(plan).toEqual({
      ...
      runtimeProgress: {
        progress: {
          ...
          cullBrandRemaining: undefined,
          shotgunShells: undefined,
          shotgunPumpRemaining: undefined,
          mirrorCurseRemaining: undefined,
          spinCurseRemaining: undefined,
          phoenixCharges: undefined,
        },
        player: { x: 4, z: 7 },
      },
