...
describe("CombatPose", () => {
  ...
  test("movement and seamless floor detection use the canonical standing height", async () => {
    ...
    expect(shell).toContain("player.position.y - PLAYER_COMBAT_EYE_HEIGHT");
    expect(shell).not.toContain("FloorTransitionDirector");
