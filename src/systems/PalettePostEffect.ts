...
export interface PaletteQuantizationTuning {
  /** Coverage of the ordered transition between the two nearest palette colors. */
...
export const PALETTE_POST_EFFECT_PROFILES: readonly PalettePostEffectProfile[] = Object.freeze([
  {
    ...
    quantization: {
      ditherAmplitude: 0.95,
      patternScale: 1,
      shadowStart: 0.06,
      shadowEnd: 0.24,
      flatSuppression: 0.72,
      detailBoost: 1.35,
      lightnessBias: 0.07,
      lightnessWeight: 6,
      chromaWeight: 0.35,
  ...
  },
  {
    ...
    recommendedDitherStrength: 0.68,
    quantization: {
      ditherAmplitude: 1,
      patternScale: 1,
      shadowStart: 0.08,
  ...
  },
  {
    ...
    recommendedDitherStrength: 0.6,
    quantization: {
      ditherAmplitude: 0.9,
      patternScale: 1,
      shadowStart: 0.07,
      shadowEnd: 0.25,
      flatSuppression: 0.88,
      detailBoost: 1.5,
      lightnessBias: 0.042,
      lightnessWeight: 6,
      chromaWeight: 0.32,
