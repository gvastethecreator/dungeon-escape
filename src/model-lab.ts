...
function createBiomeDoorQa(
  ...
  const leafMaterial = new THREE.MeshStandardMaterial({
    ...
    map: loadDoorQaTexture(`${base}.png`, true),
    normalMap: loadDoorQaTexture(`${base}-normal.png`, false),
    roughnessMap: loadDoorQaTexture(`${base}-roughness.png`, false),
    metalnessMap: loadDoorQaTexture(`${base}-metalness.png`, false),
